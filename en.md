...
Concerning _fd_'s speed, the main credit goes to the `regex` and `ignore` crates that are also used
...
If called with just a single argument like this, _fd_ searches the current directory recursively
